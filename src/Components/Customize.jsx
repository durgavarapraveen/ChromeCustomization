...
import gif from '../assets/Dkj.gif'
...
function Customize() {
  ...
  return (
    <div className=' h-100 min-h-screen p-0 m-0 bg-30303A relative'>
        <div style={{visibility: Listening ? 'visible': 'hidden'}} className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  zIndex-999 '>
            <img src={gif} style={{width: '300px', height: '300px'}} />
        </div>

        <div style={{visibility: Listening ? 'hidden' : 'visible'}} >
            ...
            <div className='w-full sm:py-10 flex items-center justify-center'>
                ...
                <div className='flex md:flex-row flex-col-reverse'>
                    <div className='flex row '>
                        ...
                        <div onClick={handleListenSpeach} className='bg-#565656 flex items-center justify-center mx-1 rounded-tr-xl'>
